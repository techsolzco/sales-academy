  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Manage approved resellers and their commissions.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 group-hover:text-brand-600 transition">{reseller.full_name}</h3>
        ...
        {resellers.length === 0 && (
          <div className="col-span-full text-center py-12 bg-white rounded-2xl border border-gray-100">
            <p className="text-gray-500">No active sales partners found.</p>
          </div>
        )}
      </div>
    </div>
