    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto p-6 animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-gray-700 mb-1">Customer Objection Text *</label>
            <input
              required
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-700 mb-1">What the Customer Really Means</label>
            <input
              value={form.meaning}
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 rounded-lg border border-emerald-200 bg-emerald-50/20 text-sm focus:ring-2 focus:ring-emerald-400 focus:outline-none resize-none"
            />
          </div>

          <div>
            <label className="block text-xs font-semibold text-red-700 mb-1">🚫 DO NOT SAY</label>
            <textarea
              rows={2}
              ...
              className="w-full px-3 py-2 rounded-lg border border-red-200 bg-red-50/20 text-sm focus:ring-2 focus:ring-red-400 focus:outline-none resize-none"
            />
          </div>
