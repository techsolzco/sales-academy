              ...
              <div className="p-4 border-t border-gray-100 bg-gray-50/50">
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-900 mt-1 capitalize">{app.knowledge_level}</p>
                  </div>
                  <div>
                    <h5 className="text-xs font-semibold text-gray-500 uppercase">Desired Course</h5>
                    <p className="text-sm text-gray-900 mt-1">{app.desired_course}</p>
                  </div>
                  <div className="col-span-2">
                    <h5 className="text-xs font-semibold text-gray-500 uppercase">Reason</h5>
                    <p className="text-sm text-gray-900 mt-1">{app.reason}</p>
                  </div>
                  <div className="col-span-2">
                    <h5 className="text-xs font-semibold text-gray-500 uppercase">Prior Experience</h5>
                    <p className="text-sm text-gray-900 mt-1">{app.prior_experience}</p>
                  </div>
                </div>
                  ...
                  <div className="flex gap-2 justify-end pt-4 border-t border-gray-200">
                    {showRejectInputFor === app.id ? (
                      <div className="flex gap-2 items-center flex-1">
                        ...
                        <button onClick={() => handleReject(app.id)} className="bg-red-600 text-white px-3 py-1.5 rounded-lg text-sm font-medium hover:bg-red-700">Submit</button>
                      ...
                      <>
                        ...
                        <button onClick={() => handleApprove(app.id)} className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-green-600 bg-green-50 hover:bg-green-100 text-sm font-medium transition">
