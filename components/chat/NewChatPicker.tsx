...
export function NewChatPicker({ 
  ...
  return (
    <div className="h-full bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 flex flex-col">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">New Conversation</h2>
        <button onClick={onCancel} className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 font-medium text-sm">
          Cancel
        </button>
      </div>
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="block w-full pl-10 pr-3 py-2 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-brand-500 focus:border-brand-500 sm:text-sm dark:bg-gray-700"
          value={search}
          ...
          <div className="space-y-2">
            {filtered.map(user => (
              <button
                ...
                disabled={isStarting}
                className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-brand-50 dark:hover:bg-brand-900/20 transition-colors border border-transparent hover:border-brand-100 dark:hover:border-brand-800 text-left disabled:opacity-50"
              >
