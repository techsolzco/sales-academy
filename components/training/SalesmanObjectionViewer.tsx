      ...
      <div className="mb-6 flex flex-col md:flex-row gap-4 max-w-2xl">
        ...
        {tools.length > 0 && (
          <select
            ...
            className="px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700 text-sm text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-brand-400 min-w-[200px]"
          >
